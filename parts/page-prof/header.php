<meta charset="UTF-8">
    ...
    <link rel="stylesheet" href="<?php echo get_template_directory_uri(); ?>/css/front-page/index_sp.css" media="screen and (max-width:590px)">
    <link rel="stylesheet" href="<?php echo get_template_directory_uri(); ?>/css/front-page/index.css" media="screen and (min-width:591px)">
    <?php wp_head(); ?>